...
const Hero = () => (
  <div className="relative text-center flex flex-col justify-center items-center px-8 bg-curvy-mobile bg-no-repeat bg-center after:absolute after:w-full after:bg-dark-blue-main after:h-[14rem] after:bottom-0 after:z-0">
